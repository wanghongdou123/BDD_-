...
Feature: Query specified vehicle information and Estimated price
  ...
  Background: This is a set of search criteria data
    |品牌     |车型           |年款   |销售名称                       |首次上牌     |上牌城市    |行驶里程  |手机号       |姓名            |验证码  |新车含税价 |
    |奥迪     |A3 Limousine   |2016  |1.8TFSI 双离合 40TFSI 风尚型   |2016年6月    |北京 北京   |2.61	  |15512345678 |阿尔扎提·阿尔西丁 |123456 |25.39    |
  ...
  Scenario: select four conditions estimate prices
    ...
    When I click button "马上估值"
    Then I can see a popup window showing "请输入您的手机号码" appears in the middle of the screen


  Scenario: select five conditions but delete entered phone number estimate prices
    Given I have install the app named "车辆估价平台" and open the app home page
    And there have "已有100,000,000人次进行了车辆的精准评估" at the top of page,Each visit, counting plus 1
    And there have three selection boxes are "选择车型"、"首次上牌"、"上牌城市" besides there have input boxes are "行驶里程"、"手机号码"
    And there have a button is "马上估值"
    ...
    When I click "请输入手机号"
    And I enter "15512345678"
    Then I can see "手机号码" is "15512345678"

    When I delete the phone number is "15512345678"
    And I click button "马上估值"
    Then I can see a popup window showing "请输入您的手机号码" appears in the middle of the screen


  Scenario: select five conditions but the fifth is invalid estimate prices
    Given I have install the app named "车辆估价平台" and open the app home page
    And there have "已有100,000,000人次进行了车辆的精准评估" at the top of page,Each visit, counting plus 1
    And there have three selection boxes are "选择车型"、"首次上牌"、"上牌城市" besides there have input boxes are "行驶里程"、"手机号码"
    And there have a button is "马上估值"
    ...
    When I click "请输入手机号"
    And I enter "23455678908"
    Then I can see "手机号码" is "23455678908"

    When I delete the phone number is "23455678908"
    And I click button "马上估值"
    Then I can see a popup window showing "请输入有效的手机号码" appears in the middle of the screen

    When I click "请输入手机号"
    And I enter "234556789098"
    Then I can see "手机号码" is "234556789098"

    When I click button "马上估值"
    Then I can see a popup window showing "请输入11位有效手机号码" appears in the middle of the screen
    ...
    When I click "请输入手机号"
    And I enter "1551234567"
    Then I can see "手机号码" is "1551234567"
  ...
  Scenario: select five conditions estimate prices
    Given I have install the app named "车辆估价平台" and open the app home page
    And there have "已有100,000,000人次进行了车辆的精准评估" at the top of page,Each visit, counting plus 1
    And there have three selection boxes are "选择车型"、"首次上牌"、"上牌城市" besides there have input boxes are "行驶里程"、"手机号码"
    And there have a button is "马上估值"
  ...
  Scenario: Check session plus 1
    ...
    And I can see "手机号码" is "15512345678"
